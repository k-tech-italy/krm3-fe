...
const ContactListTile = (props: Props) => {
  return (
    <Link
      ...
      className="bg-card-dim rounded-xl p-2 sm:p-3 m-2 border-2 border-gray-300 grid grid-cols-[auto_auto_2fr_2fr_2fr]
    ...
    >
      {props.contact.picture ? (
        ...
        <div
          className="w-8 h-8 sm:w-16 sm:h-16 rounded-xl bg-card-dim border border-gray-400 transition-none flex items-center justify-center"
      ...
      {props.contact.company && props.contact.company.picture ? (
        ...
        <div className="w-8 h-8 sm:w-16 sm:h-16 rounded-xl ml-2 sm:ml-5 bg-card-dim border border-gray-400 transition-none flex items-center justify-center">
