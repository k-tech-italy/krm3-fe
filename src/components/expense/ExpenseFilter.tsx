            ...
            <div className="my-4">
                <form className="flex flex-wrap">
                    ...
                    <div className="w-full md:w-1/3 px-2 flex items-end">
                        <button
                            type="button"
                            className="bg-krm3-primay text-white px-4 py-2 rounded-md hover:bg-yellow-400"
                            onClick={() => {
                                if (fromDate) {
                        ...
                        <button
                            type="button"
                            className="bg-krm3-primay text-white px-4 py-2 rounded-md hover:bg-yellow-400 ml-2"
                            onClick={() => {
