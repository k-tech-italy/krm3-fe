        ...
        <div className="flex items-center  bg-white justify-center w-full py-3 space-x-4 mt-5">
          ...
          {window.location.pathname !== "/timesheet" && (
            <div className="relative w-full flex justify-center">
              ...
              <button
                className="absolute -top-6 w-14 h-14 bg-yellow-500 text-white rounded-full shadow-lg flex items-center justify-center hover:bg-yellow-700 transition-transform transform hover:scale-105"
                onClick={() => {
