                ...
                <div className="flex items-center  bg-white justify-center w-full py-3 space-x-4 mt-5">
                    <button
                        className={`flex flex-col items-center w-full transition-colors ${
                            activeTab === 'home' ? 'text-yellow-400' : 'text-gray-500 hover:text-yellow-400'
                        }`}
                    ...
                    <button
                        className={`flex flex-col items-center w-full transition-colors ${
                            activeTab === 'rimborsi' ? 'text-yellow-400' : 'text-gray-500 hover:text-yellow-400'
                        }`}
                    ...
                    <button
                        className={`flex flex-col items-center w-full transition-colors ${
                            activeTab === 'timesheet' ? 'text-yellow-400' : 'text-gray-500 hover:text-yellow-400'
                        }`}
                        onClick={() => handleTabClick('timesheet', 'https://krm.k-tech.it/')}
                    >
                        <Clock size={24} />
                    ...
                    <button
                        className={`flex flex-col items-center w-full transition-colors ${
                            activeTab === 'settings' ? 'text-yellow-400' : 'text-gray-500 hover:text-yellow-400'
                        }`}
